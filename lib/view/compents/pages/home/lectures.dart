...
import '../../../../view_model/Lectures/lectures_cubit.dart';
          ...
          return  
             Scaffold(
              appBar: AppBar(
                ...
                title: Center(
                  child: Text("Lectures",style: TextStyle(fontSize: 27,fontWeight: FontWeight.w700,color: Colors.black),)),
              ),
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(myCubit
                                            .data!.data![index].lectureStartTime
                                            .toString(),style:TextStyle(fontSize: 13,fontWeight: FontWeight.w900),),
                                              ],
                                            )
                                          ],
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text( myCubit
                                            .data!.data![index].lectureEndTime
                                            .toString(),style:  TextStyle(fontSize: 13,fontWeight: FontWeight.w900),),
                                              ],
                                            )
                                          ],
